...
Currently in its 12th edition, NITMUN has been extremely successful in providing the perfect experience to each delegate. Over the years, we have entertained more than 1000 delegates in total. Delegates arrive from all corners of India for an experience they will never forget."/>
        ...
        <Artist1 orderContent={1} orderImage={2} imagesrc = "./assets/about_images/unsc_poster.png" studyguide="./assets/UNSC_study_guide.pdf" portfolio="./assets/UNSC_PORTFOLIO.pdf"comnumber="02" comshorttext="UNSC" comparatext ="Deliberation on the military crisis in Sudan with emphasis on the human rights violations and the use of weapons of mass destruction." comfulltext="United Nations Security Council" />
