...
Currently in its 12th edition, NITMUN has been extremely successful in providing the perfect experience to each delegate. Over the years, we have entertained more than 1000 delegates in total. Delegates arrive from all corners of India for an experience they will never forget."/>
        <Artist1 orderContent={2} orderImage={1} imagesrc = "./assets/about_images/unga_poster.png" studyguide="./assets/Unga_specpol_sg.pdf" portfolio="./assets/Unga_portfolio_matrix.pdf" comnumber="01" comshorttext="UNGA" comparatext ="Deliberation upon the violation of Taiwan's territorial rights by China by emphasising upon social tensions over identity, democracy and humanitarian worries stemming from potential instability." comfulltext="United Nations General Assembly" />
        <Artist1 orderContent={1} orderImage={2} imagesrc = "./assets/about_images/unsc_poster.png" studyguide="./assets/UNSC_study_guide.pdf" portfolio="UNSC_PORTFOLIO_MATRIX.pdf"comnumber="02" comshorttext="UNSC" comparatext ="Deliberation on the military crisis in Sudan with emphasis on the human rights violations and the use of weapons of mass destruction." comfulltext="United Nations Security Council" />
        <Artist1 orderContent={2} orderImage={1} imagesrc = "./assets/about_images/aippm_poster.jpg" studyguide="./assets/AIPPM_STUDY_GUIDE.pdf" portfolio="AIPPM_PORTFOLIO_MATRIX.pdf"comnumber="03" comshorttext = "AIPPM" comparatext ="Discussing the crisis in Manipur with emphasis on communal violence and violation of Suspension of Operations Agreement and legislating ways to restore peace." comfulltext="All India Political Parties Meet"/>
