...
Currently in its 12th edition, NITMUN has been extremely successful in providing the perfect experience to each delegate. Over the years, we have entertained more than 1000 delegates in total. Delegates arrive from all corners of India for an experience they will never forget."/>
        <Artist1 orderContent={2} orderImage={1} imagesrc = "./assets/about_images/unga_poster.png" studyguide="./assets/UNGA_STUDY_GUIDE.pdf" portfolio="./assets/UNGA_PORTFOLIO_MATRIX.pdf" comnumber="01" comshorttext="UNGA" comparatext ="Deliberation upon the violation of Taiwan's territorial rights by China by emphasising upon social tensions over identity, democracy and humanitarian worries stemming from potential instability." comfulltext="United Nations General Assembly" />
        <Artist1 orderContent={1} orderImage={2} imagesrc = "./assets/about_images/unsc_poster.png" studyguide="https://drive.google.com/file/d/1Bthn3sDmLbVCs1Ki3AqyxY25WoAmT9_e/view" portfolio="https://drive.google.com/file/d/1Bds5w04YTxXqcFbsjXOqBIRAUtwkpxle/view"comnumber="02" comshorttext="UNSC" comparatext ="Deliberation on the military crisis in Sudan with emphasis on the human rights violations and the use of weapons of mass destruction." comfulltext="United Nations Security Council" />
        <Artist1 orderContent={2} orderImage={1} imagesrc = "./assets/about_images/aippm_poster.jpg" studyguide="https://drive.google.com/file/d/1BZ0P7beOnt5-r521ZLTDdxs9JCCr2h1S/view" portfolio="https://drive.google.com/file/d/1BrC03ptBNZZzGWPnZUkiCWYQ0QP9jXgA/view"comnumber="03" comshorttext = "AIPPM" comparatext ="Discussing the crisis in Manipur with emphasis on communal violence and violation of Suspension of Operations Agreement and legislating ways to restore peace." comfulltext="All India Political Parties Meet"/>
        <Artist1 orderContent={1} orderImage={2} imagesrc = "./assets/about_images/ip_poster.jpg" studyguide="https://www.un.org/en/pdfs/18-00159e_un_system_chart_17x11_4c_en_web.pdf" portfolio="https://drive.google.com/file/d/1BrC03ptBNZZzGWPnZUkiCWYQ0QP9jXgA/view" comnumber="04" comshorttext="IP" comparatext ="Presenting to you an independent body, comprising of fearless reporters who with their thorough research, well-placed questions and detailed reports, uncover the hidden truth." comfulltext="International Press" />
        <Footer /> 
        </>
    )
}
